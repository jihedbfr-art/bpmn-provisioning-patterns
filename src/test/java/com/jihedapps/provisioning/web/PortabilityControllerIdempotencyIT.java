...
class PortabilityControllerIdempotencyIT {
    ...
    @Test
    void shouldBeIdempotentWhenSameEventIdProvided() {
        ...
        // Submit the same response twice
        portabilityController.submitDonorResponse(requestId, requestBody);
        portabilityController.submitDonorResponse(requestId, requestBody);
